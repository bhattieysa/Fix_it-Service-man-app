...
{item.item.document_status=="Approved"?
                                    ...
                                    <FastImage
                                        style={{ width: wide * 0.15, height: wide * 0.15, resizeMode: 'stretch', borderRadius: wide * 0.03 }}
                                        source={{ uri: api.Image_Admin_URL + item.item.image }} />
                                    <Text style={{ alignSelf: 'center', marginTop: wide * 0.005, fontSize: wide * 0.045, color: '#000000' }}>{item.item.name}</Text>
